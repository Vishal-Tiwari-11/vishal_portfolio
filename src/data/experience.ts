...
export const experience: ExperienceItem[] = [
  {
    ...
    stack: ['PHP (PDO)', 'MySQL', 'React.js', 'Next.js', 'Razorpay', 'Cashfree', 'JavaScript'],
  },
  {
    ...
    achievements: [
      ...
      'Designed and developed end-to-end event booking systems with payment integration, handling 200+ transactions per event',
